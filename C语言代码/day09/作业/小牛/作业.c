...
5. 在定义int  m[ ][3]={1，2，3，4，5，6}；后，m[1][0]的值是( )。
A. 4           B. 1                C. 2                 D. 5
...
8. 若有以下定义语句，则表达式“x[1][1]*x[2][2]”的值是( )。
...
19. 若有数组定义: char array [ ]="China"; 则数组 array所占的空间为( )。
