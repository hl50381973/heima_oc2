...
//        播放胜利音效
        ...
        playerScore++;
        // 3. 重新设置标签文本
        [_playerScoreLabel setText:[NSString stringWithFormat:@"%d", playerScore]];
    ...
    }else if (computerSelect ==  playerSelect)
    {
        ...
        computerScore++;
        [_computerScoreLabel setText:[NSString stringWithFormat:@"%d", computerScore]];
    }
